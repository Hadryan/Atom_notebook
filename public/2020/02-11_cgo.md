...
CFLAGS="-lgomp -L/usr/lib/x86_64-linux-gnu -lvulkan -Incnn/include"
# lib facemodel
...
g++ test/test_retinaface.cpp retinaface/retinaface.cpp ncnn/lib/libncnn.a -lgomp -Iretinaface -Incnn/include $CFLAGS
...
```
```sh
alias AG="/home/leondgarse/Android/Sdk/ndk/*/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi29-clang++"
alias AR="/home/leondgarse/Android/Sdk/ndk/20.0.5594570/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar"
...
mkdir -p dest/faceModel dest/mtcnn
cp faceModel/ncnn.* dest/faceModel
cp mtcnn/det* dest/mtcnn
cp test/config.yaml dest
```
```sh
